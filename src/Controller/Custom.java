...
implements WindowListener
{
	...
	private JTextArea value = new JTextArea("1:00");

	private JButton enter = new JButton("Set");
	private Board parent;

	public Custom(Board parent1)
	{
		setTitle("Enter time");
		this.parent = parent1;
	...
	public void Ok()
	{
		String send = this.value.getText();

		int test = send.length();
		String sec = send.substring(2, 3);

		if (test == 3) send = "0:0" + sec;

		this.parent.setOT(send);
