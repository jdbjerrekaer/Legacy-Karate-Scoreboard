...
public class CustomTournament extends JDialog
        implements WindowListener
{
    private static final long serialVersionUID = 3405825746157476552L;
    private JTextArea value = new JTextArea("e.g. WCK Tournament");

    private JButton enter = new JButton("Set");
    private Board parent;

    public CustomTournament(Board parent1)
    {
        setTitle("Enter Tournament");
        this.parent = parent1;
    ...
    public void Ok()
    {
        String name = this.value.getText();

        this.parent.moni.setTournamentName(name);
    ...
    private void create()
    {
        ...
        addComponent(cont, this.value, 20, 20, 600, 40);
        addComponent(cont, this.enter, 650, 20, 75, 40);
